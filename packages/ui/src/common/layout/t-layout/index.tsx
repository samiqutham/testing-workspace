...
import TLeftSidebar from "@workspace/ui/common/components/t-view/t-left-sidebar/index";
...
export default function TabLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden">
      ...
      <TLeftSidebar />
      <main
        className={`relative ml-[50] mr-[10px] z-10 flex flex-col transition-all duration-300 ease-in-out`}>
        {children}
