...
export default function MCasinoBrowse() {
  ...
  const submenuItems = ["Slots", "Roulette", "Poker", "Blackjack"];
  // 🔹 New sections
  const quickLinks = [
    { title: "Favourites", icon: "favoritos" },
    { title: "Recent", icon: "raceTime" },
    { title: "Challenges", icon: "casino", white: true },
    { title: "My Bets", icon: "bets" },
  ];

  const gameLinks = [
    { title: "New Releases", icon: "casino" },
    { title: "Slots", icon: "casino" },
    { title: "Stake Originals", icon: "casino" },
    { title: "Stake Exclusives", icon: "casino" },
    { title: "Live Casino", icon: "casino" },
    { title: "Game Shows", icon: "casino" },
    { title: "Burst Games", icon: "casino" },
    { title: "Enhanced RTP", icon: "casino" },
    { title: "Stake Poker", icon: "casino" },
    { title: "Bonus Buy", icon: "casino" },
    { title: "Blackjack", icon: "casino" },
    { title: "Baccarat", icon: "casino" },
    { title: "Roulette", icon: "casino" },
    { title: "Publishers", icon: "casino" },
  ];

  const SponsorshipsGroup = ["Sponsorships"];
  const SponsorshipsItems = ["Casino Cup", "Live Tournaments"];
      ...
      <div className="  bg-[#1a2c38] rounded-[0.25rem]">
        ...
        <div>
          {quickLinks.map((item) => (
            <button
              key={item.title}
              className="w-full flex items-center gap-2 px-4 py-[13px] text-sm font-semibold hover:bg-[#2f4553]"
            >
              <Icon
                name={item.icon}
              ...
              />
              <span
                className={`${item.white ? "text-white" : "text-[#b1bad3]"}`}
              >
                {item.title}
              </span>
            </button>
        ...
        <div>
          <div className="px-4 py-2 text-xs font-semibold uppercase">
            <span className="text-[#b1bad3]">Games</span>
          </div>
          {gameLinks.map((item) => (
            <button
              key={item.title}
            ...
            >
              <Icon
                ...
                fill="#b1bad3"
              />
              <span className="text-[#fff]">{item.title}</span>
            </button>
          ))}
        </div>
