  ...
  `}
                >
                  <div className="flex items-center gap-[8px]">
                    <div className="bg-[url('@workspace/ui/assets/sprite/casino-sprite.svg')] bg-no-repeat bg-[length:70px] bg-[-41px_0px]  h-[14px] w-[14px]"></div>
