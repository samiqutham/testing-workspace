export default function DArchive() {
  return (<div className="bg-[#1A2C38] rounded-lg border border-gray-700  pt-[32px]">
      <div className="grid grid-cols-3  font-semibold text-[16px] text-[#B1BAD3] px-[24px] ">
        <div className="px-4 pb-4">Date</div>
        <div className="px-4 pb-4 relative left-[-4.8px] md:left-[-8.5px] lg:left-[-11px]">Count</div>
       <div className="text-right px-4 pb-4">View</div>
      </div>
      ...
      <div className="w-[100%] mt-5 flex justify-center">
        <div className="flex flex-col items-center justify-center h-40 p-[16px] max-w-[fit-content] text-[#B1BAD3]">
          ...
          <p className="mt-6 text-[16px]">No Bet Archives</p>
        </div>
      </div>
    </div>)
}
