export default function DRaffles() {
  return <div className="bg-[#1A2C38] rounded-[8px] border border-gray-700  pt-[32px]">
    <div className="px-6 overflow-hidden">
      <div className="w-full overflow-x-auto scrollbar-hide">
        <table className="w-full">
          <thead className="!font-semibold">
            <tr>
              <th className="px-4 text-left whitespace-nowrap !font-semibold !text-[#B1BAD3]">Raffle Name</th>
              <th className="px-4 text-left whitespace-nowrap !font-semibold !text-[#B1BAD3]">Date</th>
              <th className="px-4 text-right whitespace-nowrap !font-semibold !text-[#B1BAD3]">Tickets</th>
            </tr>
          </thead>
