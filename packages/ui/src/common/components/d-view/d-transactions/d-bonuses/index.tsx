...
export default function DBonuses() {
  const [activeTab, setActiveTab] = useState("All Bonuses");
          ...
          <div className="w-full overflow-x-auto scrollbar-hide">
            <table className="w-full">
              <thead className="!font-semibold">
                <tr>
                  <th className="px-4 text-left !font-semibold !text-[#B1BAD3]">
                    Date
                  </th>
                  <th className="px-4 text-left !font-semibold !text-[#B1BAD3]">
                    Type
                  </th>
                  <th className="px-4 text-right !font-semibold !text-[#B1BAD3]">
                    Amount
                  </th>
                </tr>
              </thead>
