export default function DRaces() {
  return <div className="bg-[#1A2C38] rounded-lg border border-gray-700  pt-[32px]">
    <div className="px-6 !overflow-x-hidden">
      <div className="w-full overflow-x-auto scrollbar-hide">
        <table className="w-full">
          <thead className="!font-semibold">
            <tr>
              <th className="px-4 text-left whitespace-nowrap !font-semibold !text-[#B1BAD3]">Race Name</th>
              <th className="px-4 text-left !font-semibold !text-[#B1BAD3]">Date</th>
              <th className="px-4 text-left !font-semibold !text-[#B1BAD3]">Position</th>
              <th className="px-4 text-right !font-semibold !text-[#B1BAD3]">Prize</th>
            </tr>
          </thead>
    ...
    <div className="w-[100%] mt-5 p-[16px] !pb-[0px] flex justify-center">
      <div className="flex flex-col items-center justify-center h-40 p-[16px] max-w-[fit-content] text-[#B1BAD3]">
        <svg
          width="80"
          height="80"
          viewBox="0 0 80 80"
