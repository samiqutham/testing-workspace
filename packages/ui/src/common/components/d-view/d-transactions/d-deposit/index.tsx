export default function DDeposit() {
  return (
    <div className="bg-[#1A2C38] rounded-[8px] border border-gray-700  pt-[32px]">
      <div className="px-6 overflow-hidden">
        <div className="w-full overflow-x-auto scrollbar-hide">
          <table className="w-full overflow-x-auto">
            <thead className="!font-semibold">
              <tr>
                <th className="px-4 text-left whitespace-nowrap !font-semibold !text-[#B1BAD3]">Date</th>
                <th className="px-4 text-left whitespace-nowrap !font-semibold !text-[#B1BAD3]">Status</th>
                <th className="px-4 text-left whitespace-nowrap !font-semibold !text-[#B1BAD3]">View</th>
                <th className="px-4 text-right whitespace-nowrap !font-semibold !text-[#B1BAD3]">Amount</th>
              </tr>
            </thead>
      ...
      <div className="w-[100%] mt-5 p-[16px] !pb-[0px] flex justify-center">
        <div className="flex flex-col items-center justify-center h-40 p-[16px] max-w-[fit-content] text-[#B1BAD3] relative min-[329px]:left-[1px] min-[700px]:left-[0px]">
          <svg
            width="80"
            height="80"
            viewBox="0 0 80 80"
          ...
          <p className="mt-6 text-[16px]">No Banking Deposits</p>
        </div>
      </div>
    </div>
  );
