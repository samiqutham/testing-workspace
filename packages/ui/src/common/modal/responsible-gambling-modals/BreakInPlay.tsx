...
const BreakInPlay = ({ open, onClose }: any) => {
      ...
      [&>button]:mt-[6px] animate-modal-popover">
                <DialogHeader className="flex !flex-row h-[60px] justify-between items-center !bg-[#1A2C38] text-white !p-4 !border-none rounded-[8px] !outline-none !shahdow-none">
                    <DialogTitle className="font-bold text-[18px] leading-[28px] !min-h-[28px] flex items-center gap-2">
                        <div className="text-[18px] font-bold font-[proxima-nova] relative -top-px">
                            Break In Play</div>
                    </DialogTitle>
                    <DialogClose asChild>
                        ...
                        <div className="flex flex-col px-4 pb-4 gap-4">
                            <div className="flex w-full flex-col justify-center">
                                ...
                                <span className="w-full text-[16px] leading-[24px] text-[#D5DCEB]">
                                    Are you sure you want to initiate a break in play from stake.com? Any decision made here is final and irreversible. By confirming your break in play, you will not be able to play on stake.com for the time you set.
                                </span>
                                ...
                                <button type="button"
                                    ...
                                    <div className="contents relative top-[1px]">Comfirm</div>
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <form className="flex w-full flex-col justify-center">
                                <label className="inline-flex relative flex-col-reverse items-start w-full">
                                    <div className="w-full flex flex-shrink-0">
                                        <div className="relative flex flex-grow w-full group:">
                                            <select className=" px-8 py-2 pl-2 w-full bg-[#0F212E] text-input shadow-input font-bold border-2 border-[#2f4553] rounded-md transition-all outline-none m-0 cursor-pointer appearance-none text-base ">
                                                <option value="6 months" className="font-semibold">1 Day</option>
                                                <option className="" value="1 year">2 Days</option>
                                                <option value="2 years">1 Weak</option>
                                                <option value="3 years">1 Month</option>
                                                <option value="4 years">2 Months</option>
                                                <option value="5 years">3 Months</option>
                                            </select>
                                ...
                                <span className="w-full mt-4 text-[16px] leading-[24px] text-[#D5DCEB]">
                                    Disclaimer: Your account will immediately be put in to "withdraw only" mode.
                                </span>
                            </form>
                        </div>
                    </div>
