  ...
  return (
    <TooltipProvider>
      <div className="w-full max-w-[1200px] mx-auto mt-6">
        ...
        <div
          ref={containerRef}
          className="overflow-x-auto overflow-y-hidden no-scrollbar w-full tabs-scrollbar">
          ...
          ${
            activeMainBetsTab === tab
              ? "bg-[#2F4553] text-white relative top-[.5px]"
              : "bg-transparent text-white hover:bg-[#2F4553] hover:text-white top-0"
          }
        ...
        `}>
                  ...
                  {tab === "Race Leaderboard" && (
                    <div className="font-inherit align-baseline border-0 m-0 p-0 relative top-[.5px]">
            ...
            <div translate="no" className="w-fit relative max-md:hidden">
              <select className="py-[8.5px] appearance-none  pr-[28px] w-[61px] text-white bg-[#0E212E] border-2 rounded-[0.25rem]  outline-none border-[#304553] cursor-pointer leading-[1.25rem] text-sm touch-auto shadow-[0_1px_3px_0_rgba(0,0,0,0.2),0_1px_2px_0_rgba(0,0,0,0.12)] pl-[8px] font-semibold">
                <option>10</option>
                <option>20</option>
                <option>30</option>
                <option>40</option>
              ...
              <Icon
                ...
                height={16}
                fill="#B1BAD3"
                className=" !w-[16px] !h-[16px] rotate-0 absolute top-[12px] right-[8px]"></Icon>
            </div>
          </div>
        </div>
            ...
            <table className="w-full table-fixed border-collapse border-spacing-0 relative">
              ...
              <thead className="bg-[#1A2C38] text-sm leading-[23.79px] cursor-default w-full table-fixed">
                <tr>
                  ...
                  <th className="text-right p-4 text-[#b1bad3] font-semibold w-1/6 hidden min-[768px]:table-cell">
                    Bet Amount
                  </th>
                  <th className="text-right p-4 text-[#b1bad3] font-semibold w-1/6 hidden min-[1020px]:table-cell">
                    Multiplier
