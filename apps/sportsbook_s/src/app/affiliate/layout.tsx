                        ...
                        {links.map((link) => {
                          ...
                          return (
                            <div
                              ...
                              className={`py-[10px] w-full px-5 cursor-pointer transition-colors font-semibold text-white ${isActive
                          ...
                          {links.map((link, index) => {
                            ...
                            return (
                              <div
                                ...
                                className={`block py-3 px-4 font-medium border-b border-gray-100 last:border-0 transition-colors ${isActive
                                    ? "text-[#1475E1] bg-blue-50"
                                    : "text-gray-700 hover:bg-gray-50"
                                  } ${index === 0 ? "rounded-t-md" : ""} ${index === links.length - 1
                                    ? "rounded-b-md"
                                    : ""
                                  }`}>
                                {link.label}
