...
export default function SettingsLayout({
  ...
  const links = [
    ...
    { href: "/settings/verification", label: "Verification" }, // modal target
        ...
        <div className="pb-8">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col [@media(min-width:915px)]:flex-row gap-2 [@media(min-width:915px)]:gap-6">
              ...
              {/* Main Content */}
              <div
                className={`relative rounded-md bg-[#0f212eff] w-full overflow-hidden h-full ${
                  pathname === "/settings" ? "p-0" : "p-6"
                }`}
              >
                {children}
