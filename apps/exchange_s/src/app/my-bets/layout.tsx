            ...
            <div className="pt-6">
              <div className="flex justify-between w-full items-center">
                <div className="flex gap-2 h-[36px] items-center">
                  <Icon
                    name={"myBet"}
                    className="inline-block shrink-0 text-[rgb(177,186,211)] h-6 w-6"
                  />
              ...
              <div className="flex [@media(min-width:915px)]:hidden relative  gap-2">
                ...
                <div className="relative inline-block" ref={dropdownRef}>
                  <button
                    ...
                    className="w-fit bg-[#0f212e] cursor-pointer text-white py-[10px] px-5 h-[44px] rounded-md leading-[24px] min-w-[117.86px] font-semibold flex items-center gap-2  transition-colors hover:bg-[#071824]"
                  >
                    <span>
