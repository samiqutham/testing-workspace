...
export default function TransacrionsLayout({
  children,
}: {
  ...
  return (
    <div className="w-full px-[3dvw] flex justify-center items-center">
              ...
              pathname !== "/transactions" ? (
                <div className="flex [@media(min-width:915px)]:hidden relative gap-2">
                  <div
                    ...
                    <Icon name="arrowDown" className="w-5 h-5 rotate-90 text-white" />
                  </div>
                  <div className="relative inline-block" ref={dropdownRef}>
                    <button
                      ...
                      <Icon
                        name="arrowDown"
                        className={`w-5 text-[#B1BAD3] h-5 ${isOpen ? "rotate-180" : ""}`}
                      />
                    </button>
